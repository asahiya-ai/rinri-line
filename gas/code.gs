...
function handleScore(data) {
  ...
  var userMessage = '以下の講話テキストを7項目で採点し、JSONで返してください。\n\n'
    + '採点者: ' + speakerName + 'さん\n\n'
    + '【採点スタイル】\n'
    + '・講話者の努力と勇気を認めつつ、客観的に採点してください\n'
    + '・一般的な講話の目安：70〜85点、優れた講話：86〜92点、非常に優れた講話：93点以上\n'
    + '・できている部分は評価しつつ、改善点は正直に減点してください\n'
